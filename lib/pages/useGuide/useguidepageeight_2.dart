...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: UseGuidePageEight_2(),
    );
  }
}

class UseGuidePageEight_2 extends StatefulWidget {
  @override
  _UseGuidePageEight_2State createState() => _UseGuidePageEight_2State();
}

class _UseGuidePageEight_2State extends State<UseGuidePageEight_2>
                        ...
                        Stack(
                          ...
                          children: <Widget>[
                            Container(
                              width: 259,
                              height: 328,
                              child: Image.asset("assets/images/blurafter.png"),
                            ),
                            // Positioned(

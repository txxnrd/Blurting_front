...
/*여기서부터 내 정보 요청하기*/
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      ...
      final result = await Navigator.push(
        ...
        // ),
                  PageRouteBuilder(
            pageBuilder: (context, animation, secondaryAnimation) => MyPageEdit(data: data),
            transitionsBuilder:
